...
class Band(models.Model):
    ...
    genre = models.CharField(max_length=2, choices=choices.get_genres(), default=0)
    image = models.ImageField(upload_to='bands_photos', null=False, blank=False)
    country = models.PositiveSmallIntegerField(choices=choices.get_countries(), default='PL')
